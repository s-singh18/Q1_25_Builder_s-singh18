...
import { getAsset } from "../../../lib/fetchCNFT";

/**************************************************
Example API Call:
curl -X GET "http://localhost:3000/api/fetch_cnft/get_asset?asset_id=AwuMq9MLumGCbqGAe91JFffXuqQP2G3j8C8oMtFEqkiW"
***************************************************/
...
export default async function handler(
  ...
  try {
    ...
    const collectionNFT = await getAsset(assetId);
